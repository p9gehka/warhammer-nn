...
export class Medium30_1 extends DeploymentCommon {
	deploy_markers = [];
	nomansland_markers = [[6, 6], [15, 15], [24, 6], [6, 24], [24, 24]];
	objective_markers = [...this.deploy_markers, ...this.nomansland_markers];
}

export class Medium30_2 extends DeploymentCommon {
	deploy_markers = [];
	nomansland_markers = [[15, 6], [24, 15], [15, 24], [6, 15]];
	objective_markers = [...this.deploy_markers, ...this.nomansland_markers];
}

export class Medium30_3 extends DeploymentCommon {
	deploy_markers = [];
	nomansland_markers = [[8, 8], [22, 11], [8, 19], [22, 22]];
	objective_markers = [...this.deploy_markers, ...this.nomansland_markers];
}

export class Medium30_4 extends DeploymentCommon {
	deploy_markers = [];
